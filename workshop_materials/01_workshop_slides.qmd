...
## Copilot in RStudio: reflections

- Integrated into your code editor
- Less fussing over syntax
- Can speed up routine tasks
- But with new tools, we can go further...
...
This can be used as a **coding agent** that can iteratively run commands, execute tests, and adjust files until a specified goal is met. 
...
4. In the chat, ask it something like: 
  - *"Load the malaria data and create a plot showing weekly cases by district"*
...
Copilot chat is good for quick tasks. But what if we want to carry out an entire analysis with multiple sections?
