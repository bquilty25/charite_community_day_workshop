...
Most of you are probably most familiar with RStudio, so let's open that and set our working directory to the folder where you placed the malaria data, load it in, and start exploring it.
